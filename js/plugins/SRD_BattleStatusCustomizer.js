...
Imported["SumRndmDde Battle Status Customizer"] = 1.00;
...
_.loadImage = function(filename, hue) {
	return this.loadBitmap('img/SumRndmDde/battle-status/', filename, hue, false);
};
...
Scene_Battle.prototype.update = function() {
	...
	if(this._statusWindows) BattleManager.refreshStatus();
};
